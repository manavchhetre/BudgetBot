    ...
    <div className="flex items-center justify-center min-h-screen px-4 bg-bg">
      <div className="card w-full max-w-sm p-6 sm:p-8 fade-in">
        <div className="text-center mb-6">
          ...
          <p className="text-muted text-sm mt-1">Start managing your finances</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-4">
          <div>
            ...
            <input type="text" value={name} onChange={(e) => setName(e.target.value)} required placeholder="Your name" className="input-field" />
          </div>
          <div>
