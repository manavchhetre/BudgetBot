    ...
    <div className="flex items-center justify-center min-h-screen px-4">
      <div className="glass w-full max-w-md p-8 slide-up" style={{ animationDuration: '0.6s' }}>
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted text-sm mt-1">Start tracking expenses with Jerry</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-muted">
          ...
          <a href="/login" className="text-primary font-semibold hover:text-primary-hover transition-colors">
            Sign in
          </a>
        </p>
      </div>
